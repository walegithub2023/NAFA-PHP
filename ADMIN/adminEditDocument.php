...
try{
    ...
    if ($conn->query($updateSQL) !== TRUE) {
        throw new Exception();
         ...
         $_SESSION["successMessageForEditDocument"] = '<div class="alert alert-dismissible" style="background-color: rgb(7, 102, 219); color:white; font-size:120%; text-align:center;
